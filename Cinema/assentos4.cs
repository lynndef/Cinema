...
namespace Cinema
{
    public partial class assentos4 : Form
    {
        public assentos4()
        {
            InitializeComponent();
        ...
        public assentos4(Image cartaz, string nomefilme, Horarios horarios) : this(cartaz)
        {
            this.nomefilme = nomefilme;
            this.horarios = horarios;
        }

        public assentos4(string sessao, Image cartaz, string nomefilme, Horarios adaoSala1_10h30)
        {
            this.sessao = sessao;
            this.cartaz = cartaz;
            this.nomefilme = nomefilme;
        ...
        private void assentos4_Load(object sender, EventArgs e)
        {
            ImgCartaz.BackgroundImage = cartaz;
            LabelNome.Text = nomefilme;

            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[0] != 0)
            {
                btnAssento1.Visible = false;
                a1.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[1] != 0)
            {
                btnAssento2.Visible = false;
                a2.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[2] != 0)
            {
                btnAssento3.Visible = false;
                a3.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[3] != 0)
            {
                btnAssento4.Visible = false;
                a4.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[4] != 0)
            {
                btnAssento5.Visible = false;
                a5.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[5] != 0)
            {
                btnAssento6.Visible = false;
                a6.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[6] != 0)
            {
                btnAssento7.Visible = false;
                a7.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[7] != 0)
            {
                btnAssento8.Visible = false;
                a8.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[8] != 0)
            {
                btnAssento9.Visible = false;
                a9.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[9] != 0)
            {
                btnAssento10.Visible = false;
                a10.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[10] != 0)
            {
                btnAssento11.Visible = false;
                a11.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[11] != 0)
            {
                btnAssento12.Visible = false;
                a12.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[12] != 0)
            {
                btnAssento13.Visible = false;
                a13.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[13] != 0)
            {
                btnAssento14.Visible = false;
                a14.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[14] != 0)
            {
                btnAssento15.Visible = false;
                a15.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[15] != 0)
            {
                btnAssento16.Visible = false;
                a16.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[16] != 0)
            {
                btnAssento17.Visible = false;
                a17.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks4[17] != 0)
            {
        ...
        private void btnAssento1_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks4[0] = horarios.AssentosClicks4[0] + 1;

            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);


            if (horarios.AssentosClicks4[0] % 2 == 0)
            {
                horarios.AssentosClicks4[0] = 0;
        ...
        private void btnAssento2_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks4[1] = horarios.AssentosClicks4[1] + 1;


            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[1] % 2 == 0)
            {
                horarios.AssentosClicks4[1] = 0;
        ...
        private void btnAssento3_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks4[2] = horarios.AssentosClicks4[2] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[2] % 2 == 0)
            {
                horarios.AssentosClicks4[2] = 0;
        ...
        {
            horarios.AssentosClicks4[3] = horarios.AssentosClicks4[3] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[3] % 2 == 0)
            {
                horarios.AssentosClicks4[3] = 0;
        ...
        {
            horarios.AssentosClicks4[4] = horarios.AssentosClicks4[4] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[4] % 2 == 0)
            {
                horarios.AssentosClicks4[4] = 0;
        ...
        {
            horarios.AssentosClicks4[5] = horarios.AssentosClicks4[5] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[5] % 2 == 0)
            {
                horarios.AssentosClicks4[5] = 0;
        ...
        {
            horarios.AssentosClicks4[6] = horarios.AssentosClicks4[6] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[6] % 2 == 0)
            {
                horarios.AssentosClicks4[6] = 0;
        ...
        {
            horarios.AssentosClicks4[7] = horarios.AssentosClicks4[7] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[7] % 2 == 0)
            {
                horarios.AssentosClicks4[7] = 0;
        ...
        {
            horarios.AssentosClicks4[8] = horarios.AssentosClicks4[8] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[8] % 2 == 0)
            {
                horarios.AssentosClicks4[8] = 0;
        ...
        {
            horarios.AssentosClicks4[9] = horarios.AssentosClicks4[9] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[9] % 2 == 0)
            {
                horarios.AssentosClicks4[9] = 0;
        ...
        {
            horarios.AssentosClicks4[10] = horarios.AssentosClicks4[10] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[10] % 2 == 0)
            {
                horarios.AssentosClicks4[10] = 0;
        ...
        {
            horarios.AssentosClicks4[11] = horarios.AssentosClicks4[11] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[11] % 2 == 0)
            {
                horarios.AssentosClicks4[11] = 0;
        ...
        {
            horarios.AssentosClicks4[12] = horarios.AssentosClicks4[12] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[12] % 2 == 0)
            {
                horarios.AssentosClicks4[12] = 0;
        ...
        {
            horarios.AssentosClicks4[13] = horarios.AssentosClicks4[13] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[13] % 2 == 0)
            {
                horarios.AssentosClicks4[13] = 0;
        ...
        {
            horarios.AssentosClicks4[14] = horarios.AssentosClicks4[14] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[14] % 2 == 0)
            {
                horarios.AssentosClicks4[14] = 0;
        ...
        {
            horarios.AssentosClicks4[15] = horarios.AssentosClicks4[15] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[15] % 2 == 0)
            {
                horarios.AssentosClicks4[15] = 0;
        ...
        {
            horarios.AssentosClicks4[16] = horarios.AssentosClicks4[16] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[16] % 2 == 0)
            {
                horarios.AssentosClicks4[16] = 0;
        ...
        {
            horarios.AssentosClicks4[17] = horarios.AssentosClicks4[17] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks4[17] % 2 == 0)
            {
                horarios.AssentosClicks4[17] = 0;
