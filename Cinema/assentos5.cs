...
namespace Cinema
{
    public partial class assentos5 : Form
    {
        public assentos5()
        {
            InitializeComponent();
        ...
        public assentos5(Image cartaz, string nomefilme, Horarios horarios) : this(cartaz)
        {
            this.nomefilme = nomefilme;
            this.horarios = horarios;
        }

        public assentos5(string sessao, Image cartaz, string nomefilme, Horarios adaoSala1_10h30)
        {
            this.sessao = sessao;
            this.cartaz = cartaz;
            this.nomefilme = nomefilme;
        ...
        private void assentos5_Load(object sender, EventArgs e)
        {
            ImgCartaz.BackgroundImage = cartaz;
            LabelNome.Text = nomefilme;

            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[0] != 0)
            {
                btnAssento1.Visible = false;
                a1.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[1] != 0)
            {
                btnAssento2.Visible = false;
                a2.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[2] != 0)
            {
                btnAssento3.Visible = false;
                a3.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[3] != 0)
            {
                btnAssento4.Visible = false;
                a4.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[4] != 0)
            {
                btnAssento5.Visible = false;
                a5.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[5] != 0)
            {
                btnAssento6.Visible = false;
                a6.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[6] != 0)
            {
                btnAssento7.Visible = false;
                a7.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[7] != 0)
            {
                btnAssento8.Visible = false;
                a8.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[8] != 0)
            {
                btnAssento9.Visible = false;
                a9.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[9] != 0)
            {
                btnAssento10.Visible = false;
                a10.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[10] != 0)
            {
                btnAssento11.Visible = false;
                a11.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[11] != 0)
            {
                btnAssento12.Visible = false;
                a12.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[12] != 0)
            {
                btnAssento13.Visible = false;
                a13.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[13] != 0)
            {
                btnAssento14.Visible = false;
                a14.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[14] != 0)
            {
                btnAssento15.Visible = false;
                a15.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[15] != 0)
            {
                btnAssento16.Visible = false;
                a16.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[16] != 0)
            {
                btnAssento17.Visible = false;
                a17.Visible = true;
            }
            if (ControleAssentos.Seg.AdaoSala1_10h30.AssentosClicks5[17] != 0)
            {
        ...
        private void btnAssento1_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks5[0] = horarios.AssentosClicks5[0] + 1;

            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);


            if (horarios.AssentosClicks5[0] % 2 == 0)
            {
                horarios.AssentosClicks5[0] = 0;
        ...
        private void btnAssento2_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks5[1] = horarios.AssentosClicks5[1] + 1;


            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[1] % 2 == 0)
            {
                horarios.AssentosClicks5[1] = 0;
        ...
        private void btnAssento3_Click(object sender, EventArgs e)
        {
            ...
            horarios.AssentosClicks5[2] = horarios.AssentosClicks5[2] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[2] % 2 == 0)
            {
                horarios.AssentosClicks5[2] = 0;
        ...
        {
            horarios.AssentosClicks5[3] = horarios.AssentosClicks5[3] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[3] % 2 == 0)
            {
                horarios.AssentosClicks5[3] = 0;
        ...
        {
            horarios.AssentosClicks5[4] = horarios.AssentosClicks5[4] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[4] % 2 == 0)
            {
                horarios.AssentosClicks5[4] = 0;
        ...
        {
            horarios.AssentosClicks5[5] = horarios.AssentosClicks5[5] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[5] % 2 == 0)
            {
                horarios.AssentosClicks5[5] = 0;
        ...
        {
            horarios.AssentosClicks5[6] = horarios.AssentosClicks5[6] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[6] % 2 == 0)
            {
                horarios.AssentosClicks5[6] = 0;
        ...
        {
            horarios.AssentosClicks5[7] = horarios.AssentosClicks5[7] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[7] % 2 == 0)
            {
                horarios.AssentosClicks5[7] = 0;
        ...
        {
            horarios.AssentosClicks5[8] = horarios.AssentosClicks5[8] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[8] % 2 == 0)
            {
                horarios.AssentosClicks5[8] = 0;
        ...
        {
            horarios.AssentosClicks5[9] = horarios.AssentosClicks5[9] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[9] % 2 == 0)
            {
                horarios.AssentosClicks5[9] = 0;
        ...
        {
            horarios.AssentosClicks5[10] = horarios.AssentosClicks5[10] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[10] % 2 == 0)
            {
                horarios.AssentosClicks5[10] = 0;
        ...
        {
            horarios.AssentosClicks5[11] = horarios.AssentosClicks5[11] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[11] % 2 == 0)
            {
                horarios.AssentosClicks5[11] = 0;
        ...
        {
            horarios.AssentosClicks5[12] = horarios.AssentosClicks5[12] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[12] % 2 == 0)
            {
                horarios.AssentosClicks5[12] = 0;
        ...
        {
            horarios.AssentosClicks5[13] = horarios.AssentosClicks5[13] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[13] % 2 == 0)
            {
                horarios.AssentosClicks5[13] = 0;
        ...
        {
            horarios.AssentosClicks5[14] = horarios.AssentosClicks5[14] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[14] % 2 == 0)
            {
                horarios.AssentosClicks5[14] = 0;
        ...
        {
            horarios.AssentosClicks5[15] = horarios.AssentosClicks5[15] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[15] % 2 == 0)
            {
                horarios.AssentosClicks5[15] = 0;
        ...
        {
            horarios.AssentosClicks5[16] = horarios.AssentosClicks5[16] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[16] % 2 == 0)
            {
                horarios.AssentosClicks5[16] = 0;
        ...
        {
            horarios.AssentosClicks5[17] = horarios.AssentosClicks5[17] + 1;
            int nAssentos = Convert.ToInt32(LabelNassentos.Text);
            int labelzero = Convert.ToInt32(label0.Text);

            if (horarios.AssentosClicks5[17] % 2 == 0)
            {
                horarios.AssentosClicks5[17] = 0;
